# File: feedgen/parsers/googlenews.py
# Author: J. Cardenzana (c) 2022
# =============================================================================
# File defines the GoogleNews site parser. This method allows adding site results
# from Google news search. Results from specific news sites can be searched by
# passing them to the `add_site()` method.
#
# This parser adds the following tags to each in generated feeds:
#    - src_name: Google News
#    - src_url: https://news.google.com/
# =============================================================================
